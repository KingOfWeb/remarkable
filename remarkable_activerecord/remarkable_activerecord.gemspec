...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<remarkable>, ["~> 4.0.0.alpha4Rails31"])
      s.add_runtime_dependency(%q<remarkable_activemodel>, ["~> 4.0.0.alpha4Rails31"])
    else
      s.add_dependency(%q<rspec>, [">= 2.0.0.alpha11"])
      s.add_dependency(%q<remarkable>, ["~> 4.0.0.alpha4Rails31"])
      s.add_dependency(%q<remarkable_activemodel>, ["~> 4.0.0.alpha4Rails31"])
    end
  else
    s.add_dependency(%q<rspec>, [">= 2.0.0.alpha11"])
    s.add_dependency(%q<remarkable>, ["~> 4.0.0.alpha4Rails31"])
